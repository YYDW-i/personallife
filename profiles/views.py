...
def settings_view(request):
    ...
    if request.method == "POST":
        old = (profile.height_cm, profile.weight_kg, profile.age_year,profile.gender,profile.exercise_frequency, profile.exercise_time_minutes, profile.sleep_hours)
        ...
        if form.is_valid():
            ...
            new = (profile.height_cm, profile.weight_kg, profile.age_year,profile.gender,profile.exercise_frequency, profile.exercise_time_minutes, profile.sleep_hours)
